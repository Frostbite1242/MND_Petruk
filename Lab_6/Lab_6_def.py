...
def function(X1, X2, X3):
    y = 9.2 + 6.0 * X1 + 3.2 * X2 + 3.2 * X3 + 6.6 * X1 * X1 + 0.1 * X2 * X2 + 4.9 * X3 * X3 + 6.9 * X1 * X2 + \
        0.9 * X1 * X3 + 3.5 * X2 * X3 + 0.9 * X1 * X2 * X3
    return y
...
def main(n,m):
    ...
    while True:
        ...
        if res1 >= 3:
            break
    print("Незначущі коефіцієнти регресії за 3 сек: " + str(len(coefs2)))
